...
module.exports = {
    ...
    userDashboardAuthentication: function(test) {
        ...
        lmHelpers.createLocMapUser(test, testUserEmail, 'dev1', function(auth, reply) {
            lmHelpers.api.get(test, '/v1/user/' + reply.id + '/dashboard', {headers: {authorizationtoken: ''}}, lmHelpers.wrongAuthTokenResult, function() {
                test.done();
            });
        });
    },
    ...
    userDashBoardWithLocation: function(test) {
        ...
        lmHelpers.createLocMapUser(test, testUserEmail, 'dev1', function(auth, reply) {
            ...
            lmHelpers.api.post(test, '/v1/user/' + reply.id + '/location', authWithLocation, function() {
                lmHelpers.api.get(test, '/v1/user/' + reply.id + '/dashboard', auth, function(res) {
            ...
            lmHelpers.createLocMapUser(test, testUserEmail2, 'dev2', function(auth2, reply2) {
                ...
                lmHelpers.api.post(test, '/v1/user/' + reply1.id + '/allow', auth1, function() {
                    ...
                    lmHelpers.api.get(test, '/v1/user/' + reply2.id + '/dashboard', auth2, function(res) {
                        ...
                        lmHelpers.api.get(test, '/v1/user/' + reply1.id + '/dashboard', auth1, function(res2) {
    ...
    allowAnotherUserRemove: function(test) {
        ...
        lmHelpers.createLocMapUser(test, testUserEmail, 'dev1', function(auth1, reply1) {
            lmHelpers.createLocMapUser(test, testUserEmail2, 'dev2', function(auth2, reply2) {
                ...
                lmHelpers.api.post(test, '/v1/user/' + reply1.id + '/allow', authWithEmail1, function() {
                    lmHelpers.api.del(test, '/v1/user/' + reply1.id + '/allow/' + reply2.id, auth1, function() {
    ...
    cannotAllowSelf: function(test) {
        ...
        lmHelpers.createLocMapUser(test, testUserEmail, 'dev1', function(auth1, reply1) {
            ...
            lmHelpers.api.post(test, '/v1/user/' + reply1.id + '/allow', authWithEmail, {status: 400}, function() {
    ...
    allowWithUpperCasesEmail: function(test) {
        ...
        lmHelpers.createLocMapUser(test, 'testuser1@example.com', 'dev1', function(auth1, reply1) {
            lmHelpers.createLocMapUser(test, 'testuser2@example.com', 'dev2', function(auth2, reply2) {
                ...
                lmHelpers.api.post(test, '/v1/user/' + reply1.id + '/allow', authWithEmail, function() {
                    lmHelpers.api.get(test, '/v1/user/' + reply1.id + '/dashboard', auth1, function(dash) {
            ...
            lmHelpers.createLocMapUser(test, testUserEmail2, 'dev2', function(auth2, reply2) {
                lmHelpers.createLocMapUser(test, testUserEmail3, 'dev3', function(auth3, reply3) {
                    ...
                    lmHelpers.api.post(test, '/v1/user/' + reply2.id + '/allow', auth2, function() {
                        ...
                        lmHelpers.api.post(test, '/v1/user/' + reply3.id + '/allow', auth3, function() {
                            lmHelpers.api.get(test, '/v1/user/' + reply1.id + '/dashboard', auth1, function(dash) {
                                var ICanSeeData = {};
                    ...
                    lmHelpers.api.post(test, '/v1/user/' + reply1.id + '/allow', auth1, function() {
                        ...
                        lmHelpers.api.post(test, '/v1/user/' + reply1.id + '/allow', auth1, function() {
                            ...
                            lmHelpers.api.post(test, '/v1/user/' + reply1.id + '/allow', auth1, function() {
                                ...
                                lmHelpers.api.post(test, '/v1/user/' + reply1.id + '/allow', auth1, {status: 400}, function() {
                                    test.done();
                                });
                            });
                        });
    ...
    stubUserDashboardFails: function(test) {
        ...
        lmHelpers.createLocMapUser(test, testUserEmail, 'dev1', function(auth1, reply1) {
            ...
            lmHelpers.api.post(test, '/v1/user/' + reply1.id + '/allow', auth1, function() {
                ...
                lmHelpers.api.get(test, '/v1/user/b4b265d4a1a7f40c631e4dd003510ebf43f32135/dashboard', {'headers': {'authorizationtoken': ''}}, lmHelpers.wrongAuthTokenResult, function() {
                    test.done();
                });
            });
        });
    ...
    existingUserSignupWrongDeviceid: function(test) {
        test.expect(3);
        lmHelpers.createLocMapUser(test, testUserEmail, 'dev1', function() {
            lmHelpers.api.post(test, '/v1/signup', {data: {email: testUserEmail, 'device_id': 'differentid'}}, {status: 401}, function() {
                test.done();
            });
        });
    },
    ...
    setVisibility: function(test) {
        ...
        lmHelpers.createLocMapUser(test, testUserEmail, 'dev1', function(auth1, reply1) {
            ...
            lmHelpers.api.put(test, '/v1/user/' + reply1.id + '/visibility', authWithVisibility, function() {
                lmHelpers.api.get(test, '/v1/user/' + reply1.id + '/dashboard', auth1, function(dash) {
                    test.equal(dash.data.visibility, false);
                    authWithVisibility.data = {visibility: true};
                    lmHelpers.api.put(test, '/v1/user/' + reply1.id + '/visibility', authWithVisibility, function() {
                        lmHelpers.api.get(test, '/v1/user/' + reply1.id + '/dashboard', auth1, function(dash2) {
    ...
    createAndGetUserPlace: function(test) {
        ...
        lmHelpers.createLocMapUser(test, testUserEmail, 'dev1', function(auth1, reply1) {
            ...
            lmHelpers.api.post(test, '/v1/user/' + reply1.id + '/place', authWithPlace, function(result) {
                ...
                lmHelpers.api.get(test, '/v1/user/' + reply1.id + '/places', auth1, function(result2) {
        ...
        lmHelpers.createLocMapUser(test, testUserEmail, 'dev1', function(auth1, reply1) {
            ...
            lmHelpers.api.post(test, '/v1/user/' + reply1.id + '/place', authWithPlace, function(result1) {
                ...
                lmHelpers.api.get(test, '/v1/user/' + reply1.id + '/places', auth1, function(placesResult1) {
                    ...
                    authWithPlace.data = lmHelpers.locMapPlace2;
                    lmHelpers.api.put(test, '/v1/user/' + reply1.id + '/place/' + placeId1, authWithPlace, function() {
    ...
    modifyPlaceWithInvalid: function(test) {
        ...
        lmHelpers.createLocMapUser(test, testUserEmail, 'dev1', function(auth1, reply1) {
            ...
            lmHelpers.api.post(test, '/v1/user/' + reply1.id + '/place', authWithPlace, function(result1) {
                ...
                lmHelpers.api.put(test, '/v1/user/' + reply1.id + '/place/' + placeId1, authWithPlace, {status: 400}, function() {
    ...
    modifyNonExistingPlace: function(test) {
        ...
        lmHelpers.createLocMapUser(test, testUserEmail, 'dev1', function(auth1, reply1) {
            var authWithPlace = JSON.parse(JSON.stringify(auth1));
            authWithPlace.data = lmHelpers.locMapPlace1;
            lmHelpers.api.put(test, '/v1/user/' + reply1.id + '/place/wrongPlaceId', authWithPlace, {status: 404}, function() {
                test.done();
            });
        });
    },
        ...
        lmHelpers.createLocMapUser(test, testUserEmail, 'dev1', function(auth1, reply1) {
            ...
            lmHelpers.api.post(test, '/v1/user/' + reply1.id + '/place', authWithPlace, function(result1) {
                ...
                lmHelpers.api.get(test, '/v1/user/' + reply1.id + '/places', auth1, function(placesResult1) {
                    ...
                    lmHelpers.api.del(test, '/v1/user/' + reply1.id + '/place/' + placeId1, auth1, function() {
                        lmHelpers.api.get(test, '/v1/user/' + reply1.id + '/places', auth1, function(placesResult2) {
    ...
    removeNonExistingPlace: function(test) {
        test.expect(3);
        lmHelpers.createLocMapUser(test, testUserEmail, 'dev1', function(auth1, reply1) {
            lmHelpers.api.del(test, '/v1/user/' + reply1.id + '/place/wrongPlaceId', auth1, {status: 404}, function() {
                test.done();
            });
        });
    }
