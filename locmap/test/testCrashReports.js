...
module.exports = {
    ...
    storeAndGetCrashReport: function(test) {
        ...
        crashReports.store('user1', osType, report1, function(status) {
            ...
            crashReports.getMonth(osType, that.currentYear, that.currentMonth, function(status2, result) {
    ...
    storeMultipleReports: function(test) {
        ...
        crashReports.store('user1', osType, report1, function(status) {
            ...
            crashReports.store('user2', osType, report2, function(status2) {
                ...
                crashReports.getMonth(osType, that.currentYear, that.currentMonth, function(status3, result) {
